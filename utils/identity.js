"use strict";
const { fetchReticulumAuthenticated } = require("./phoenix-utils");
...
async function fetchRandomDefaultAvatarId() {
  const defaultAvatarEndpoint =
    "/api/v1/media/search?filter=default&source=avatar_listings";
  const defaultAvatars = (
    await fetchReticulumAuthenticated(defaultAvatarEndpoint)
  ).entries;
...
module.exports = { generateRandomName, fetchRandomDefaultAvatarId };
