...
class Store extends EventTarget {
  constructor(credentials) {
    ...
    if (this.localStorage.getItem(LOCAL_STORE_KEY) === null) {
      this.localStorage.setItem(LOCAL_STORE_KEY, JSON.stringify({}));
    }
  ...
  get state() {
    if (!this.hasOwnProperty(STORE_STATE_CACHE_KEY)) {
      this[STORE_STATE_CACHE_KEY] = JSON.parse(
        this.localStorage.getItem(LOCAL_STORE_KEY)
      );
    }
  ...
  update(newState, mergeOpts) {
    ...
    this.localStorage.setItem(LOCAL_STORE_KEY, JSON.stringify(finalState));
    delete this[STORE_STATE_CACHE_KEY];
